...
const bs: Translations = {
  ...
  untitledView: "Sačuvani filter bez naslova",
  cannotSaveUntitledView: "Ne možete sačuvati sačuvani filter bez naslova.",
  viewSaved: "Sačuvani filter je sačuvan",
  pagePlaceholder: "Počnite pisati nešto :)",
  newViewTitele: "Naslov novog sačuvanog filtera",
