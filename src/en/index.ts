...
const en = {
  ...
  ["billing.notesBasic"]: "Notes (basic)",
  ["billing.aiNotesNumberOfMeetingsFree"]: "%{number} meetings free",
  ["billing.voiceTaskCreationNumberOfUses"]: "%{number} uses",
  ["billing.unlimitedVoiceTaskCreation"]: "Unlimited voice task creation",
