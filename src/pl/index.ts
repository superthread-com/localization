...
const pl = {
  ...
  ["billing.unlimitedViews"]: "Nielimitowana liczba widoków",
  ...
  links: "Linki",
  createNewView: "Utwórz widok",
  newView: "Nowy widok",
  workspace: "Przestrzeń robocza",
  views: "Widoki",
  roadmap: "Mapa drogowa",
  myViews: "Moje widoki",
  workspaceViews: "Widoki przestrzeni roboczej",
  private: "Prywatne",
  ...
  cannotSaveUntitledView: "Nie można zapisać widoku bez tytułu",
  viewSaved: "widok zapisany",
  pagePlaceholder: "Napisz coś...",
  newViewTitele: "Nowy tytuł widoku",
  ...
  viewDuplicated: "Widok zduplikowany",
  viewDeleted: "Widok usunięty",
  cardDuplicateFailed: "Nie udało się zduplikować karty",
  boardDuplicateFailed: "Nie udało się zduplikować tablicy",
  viewDuplicateFailed: "Nie udało się zduplikować widoku",
  ...
  filterAcrossTheEntire:
    "Filtruj całą przestrzeń roboczą, aby stworzyć widok wszystkich kart przypisanych do Ciebie, lub stwórz globalny backlog błędów. Widoki mogą być prywatne lub udostępnione zespołowi.",
  useFiltersToCreate:
    "Używaj filtrów, aby tworzyć niestandardowe widoki tylko tych kart, które chcesz zobaczyć",
  ...
  cannotCreateViewOnMobile:
    "Nie możesz utworzyć widoku na urządzeniu mobilnym.",
  ...
  ["visit_inbox.title"]: "Sprawdź swoją skrzynkę odbiorczą",
  ["visit_inbox.tooltip"]:
  ...
  filterYourWorkspaceToCreateViews:
    "Filtruj swoją przestrzeń roboczą, aby tworzyć widoki i udostępniać je zespołowi",
  ...
  ["onboarding.quote.0"]: "Plany są bezwartościowe, ale planowanie jest wszystkim.",
  ...
  ["onboarding.quote.2"]: "Najtrudniejsze jest podjęcie decyzji o działaniu, reszta to już tylko wytrwałość.",
  ["onboarding.quote.author.2"]: "Amelia Earhart",
  ["onboarding.quote.3"]: "Za każdą minutę poświęconą na organizację zyskuje się godzinę.",
  ["onboarding.quote.author.3"]: "Benjamin Franklin",
  ["onboarding.quote.4"]: "Talent wygrywa mecze, ale współpraca wygrywa mistrzostwa.",
  ["onboarding.quote.author.4"]: "Michael Jordan",
  ["onboarding.quote.5"]: "Życie naprawdę zaczyna się, gdy zaprowadzisz porządek w swoim domu.",
