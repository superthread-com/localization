...
const zhHant = {
  ...
  untitledView: "無標題視圖",
  cannotSaveUntitledView: "無法保存無標題視圖",
  viewSaved: "視圖已保存",
  ...
  ["check_your_notifications.title"]: "在收件匣查看通知",
  ["check_your_notifications.tooltip"]: "在收件匣中追蹤您訂閱的所有內容",
