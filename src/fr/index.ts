...
const fr: Translations = {
  ...
  ["billing.notesBasic"]: "Notes (basique)",
  ["billing.aiNotesNumberOfMeetingsFree"]: "%{number} réunions gratuites",
  ["billing.voiceTaskCreationNumberOfUses"]: "%{number} utilisations",
  ["billing.unlimitedVoiceTaskCreation"]:
    "Création de tâches vocales illimitée",
  ["billing.sprints"]: "Sprints",
  ["billing.roadmapAndProjects"]: "Feuille de route & projets",
  ["billing.templates"]: "Modèles",
  ["billing.adminRoles"]: "Rôles d'administrateur",
  ["billing.unlimitedAiNotes"]: "Notes AI illimitées",
  ["billing.aiSearch"]: "Recherche AI",
