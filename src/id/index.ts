...
const id: Translations = {
  ...
  agentIcon: "Ikon agen",
  agentName: "Nama agen",
  agentNamePlaceholder: "Nama agen",
  agentInvalidNameError: "Silakan masukkan nama yang valid.",
  agentSkill: "Keahlian",
  agentRepository: "Repositori",
  agentRepositoryPlaceholder: "https://github.com/org/repo",
  agentInvalidRepositoryError: "Silakan masukkan URL repositori yang valid.",
  agentRefOptional: "Ref (opsional)",
  agentTarget: "Target",
  agentAutoCreatePr: "Buat PR otomatis",
  agentOpenAsCursorGithubApp: "Buka sebagai Cursor GitHub App",
  agentSkipReviewerRequest: "Lewati permintaan reviewer",
  agentBranchNameOptional: "Nama cabang (opsional)",
  agentApiKey: "Kunci API",
  agentApiKeyPlaceholder: "Kunci API Cursor",
  agentApiKeyHelpText:
    "Disimpan terenkripsi di backend. Biarkan kosong saat memperbarui untuk mempertahankan kunci yang ada.",
  agentCustomInstructionsOptional: "Instruksi kustom (opsional)",
  agentCustomInstructionsPlaceholder:
    "Jelaskan bagaimana agen ini harus berperilaku. Instruksi ini ditambahkan di awal setiap prompt.",
  agentRuns: "Eksekusi Agen",
  agentRunsColumnId: "ID",
  agentRunsColumnCreated: "Dibuat",
  agentRunsColumnStatus: "Status",
  agentRunsColumnInputTokens: "Token Masukan",
  agentRunsColumnOutputTokens: "Token Keluaran",
  agentRunsColumnIterations: "Iterasi",
  agentAttachedResources: "Sumber daya terlampir",
  agentAttachmentResource: "Sumber daya",
  agentAttachmentTimeAttached: "Waktu dilampirkan",
  agentAttachmentAttachedBy: "Dilampirkan oleh",
  agentDetach: "Lepaskan",
  agentAddAgent: "Tambah agen",
  agentAddAgentDescription: "Buat templat agen Cursor Cloud baru.",
  agents: "Agen",
  agentNewAgent: "Agen baru",
  agentUpdateAgent: "Perbarui agen",
  agentDeleteAgent: "Hapus agen",
  agentDeleteConfirmation:
    "Apakah Anda yakin ingin menghapus agen ini? Tindakan ini tidak dapat dibatalkan.",
  agentCreatedSuccessfully: "Agen berhasil dibuat.",
  agentUpdatedSuccessfully: "Agen berhasil diperbarui.",
  agentDeletedSuccessfully: "Agen berhasil dihapus.",
  agentLaunchedSuccessfully: "Agen berhasil diluncurkan.",
  agentLaunchFailed: "Gagal meluncurkan agen.",
  agentPromptSetSuccessfully: "Prompt agen berhasil ditetapkan.",
  agentPromptSetFailed: "Gagal menetapkan prompt agen.",
  agentResetConversationHistory: "Atur ulang riwayat percakapan",
  agentSelectThisInstruction: "Pilih instruksi ini",
  agentDebug: "[DEBUG]",
  agentIterationId: "ID Iterasi:",
  agentStatus: "Status:",
  agentReasoning: "Alasan:",
  agentFunctions: "Fungsi:",
  agentTriggers: "Pemicu:",
  agentFallbackName: "Agen",
  agentWorkOnThisCard: "Kerjakan kartu ini",
  agentActive: "Agen Aktif",
