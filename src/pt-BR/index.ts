...
const ptBR = {
  ...
  ["billing.unlimitedViews"]: "Visualizações ilimitadas",
  ...
  ["billing.category.views"]: "Visualizações",
  ...
  ["billing.customViews"]: "Visualizações personalizadas",
  ...
  links: "Links",
  createNewView: "Criar visualização",
  newView: "Nova visualização",
  workspace: "Espaço de trabalho",
  views: "Visualizações",
  roadmap: "Roteiro",
  myViews: "Minhas visualizações",
  workspaceViews: "Visualizações do espaço de trabalho",
  private: "Privado",
  ...
  untitledView: "Visualização sem título",
  cannotSaveUntitledView: "Não é possível salvar visualização sem título",
  viewSaved: "visualização salva",
  pagePlaceholder: "Escreva algo...",
  newViewTitele: "Novo título de visualização",
  ...
  viewDuplicated: "Visualização duplicada",
  ...
  viewDuplicateFailed: "Falha ao duplicar visualização",
  ...
  filterAcrossTheEntire:
    "Filtre em todo o espaço de trabalho para criar uma visão de todos os cartões atribuídos a você, ou talvez crie um backlog global de bugs. As visualizações podem ser privadas ou compartilhadas com sua equipe.",
  useFiltersToCreate:
    "Use filtros para criar visualizações personalizadas de apenas os cartões que você deseja ver",
  ...
  ["visit_inbox.title"]: "Verifique sua caixa de entrada",
  ["visit_inbox.tooltip"]:
    "Acompanhe tudo o que você está inscrito na caixa de entrada",
  ...
  filterYourWorkspaceToCreateViews:
    "Filtre seu espaço de trabalho para criar visualizações e compartilhe-as com sua equipe",
  ...
  myWorkAndNotes: "Meu trabalho & notas",
