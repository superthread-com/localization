...
const de = {
  ...
  apiAccessSubtitle: "Die API von Superthread ermöglicht es dir, benutzerdefinierte Integrationen zu erstellen. Du benötigst die folgenden Angaben, um Anfragen zu stellen",
