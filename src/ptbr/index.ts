...
const ptbr = {
  ...
  youDontHaveAnyNotes: "Você ainda não tem nenhuma nota",
  ...
  noNoteTemplates: "Nenhum modelo de nota",
  createNoteTemplate: "Criar modelo de nota",
  sections: "Seções",
  ...
  systemAccessNotAllowedDesc3:
    "Depois de fazer isso, por favor, saia e reabra este aplicativo, depois retorne aqui.",
  editNoteTemplate: "Editar modelo de nota",
  viewNoteTemplate: "Ver modelo de nota",
  viewTranscript: "Ver transcrição",
  transcribeHereInstead: "Transcrever aqui em vez disso?",
  currentlyTranscribingAnotherNote:
    "A nota “%{noteTitle}” está sendo transcrita no momento. Você quer parar a transcrição lá e transcrever aqui em vez disso?",
  ...
  openTranscribingNote: "Abrir nota de transcrição",
  ...
  selectANote: "Selecione uma nota",
  noteDoesntExist: "Nota não existe",
  ...
  automaticMeetingDetectionDescription:
    "O Superthread detecta quando um aplicativo de reunião está usando o microfone e notifica você para criar uma nota",
  ...
  onlyWhenITakeNotesForMeetingSubtitle:
    "Se você criar uma nota a partir de um evento de calendário até 5 minutos antes do horário de início, ou entrar em uma chamada de vídeo a partir de uma nota",
  ...
  transcriptionIndicatorTitle: "Indicador de transcrição",
