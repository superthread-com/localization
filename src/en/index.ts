...
const en = {
  ...
  "slash.display.embedIframe": "Embed iframe",
  "slash.display.embedFigma": "Embed Figma",
  "slash.display.embedMiro": "Embed Miro board",
  "slash.display.embedLoom": "Embed Loom video",
  "slash.display.embedExcalidraw": "Embed Excalidraw",
  "slash.display.embedLucid": "Embed Lucid chart",
  "slash.search.image": "image",
  "slash.search.video": "video",
  "slash.search.file": "file",
  ...
  "slash.search.embedIframe": "embed iframe",
  "slash.search.embedFigma": "embed figma iframe",
  "slash.search.embedMiro": "embed miro iframe",
  "slash.search.embedLoom": "embed loom iframe",
  "slash.search.embedExcalidraw": "embed excalidraw iframe",
  "slash.search.embedLucid": "embed lucid iframe",
  // menus
  ...
  ["billing.fairPrice"]: "Fair monthly pricing",
  ...
  ["billing.perUserPerMonth"]: "per user per month",
  ["billing.perUserPerYear"]: "per user per year",
  ...
  untitledView: "Untitled filter",
  cannotSaveUntitledView: "Cannot save untitled filter",
  viewSaved: "filter saved",
  pagePlaceholder: "Write something...",
  newViewTitele: "New filter title",
  ...
  viewMyWork: "View my cards",
  viewWork: "View %{displayName}'s cards",
  ...
  transcribingOnlyAvailableOnDesktop:
    "Transcribing is only available in the desktop app",
  ...
  agentInvalidRepositoryError: "Please enter a valid repository URL.",
  agentRefOptional: "Ref (optional)",
  agentTarget: "Target",
  agentAutoCreatePr: "Auto-create PR",
  agentOpenAsCursorGithubApp: "Open as Cursor GitHub App",
  agentSkipReviewerRequest: "Skip reviewer request",
  agentBranchNameOptional: "Branch name (optional)",
  agentApiKey: "API key",
  agentApiKeyPlaceholder: "Cursor API key",
  agentApiKeyHelpText:
    "Stored encrypted on the backend. Leave blank when updating to keep the existing key.",
  agentCustomInstructionsOptional: "Custom instructions (optional)",
  agentCustomInstructionsPlaceholder:
    "Describe how this agent should behave. These instructions are prepended to every prompt.",
  agentRuns: "Agent Runs",
  agentRunsColumnId: "ID",
  agentRunsColumnCreated: "Created",
  agentRunsColumnStatus: "Status",
  agentRunsColumnInputTokens: "Input Tokens",
  agentRunsColumnOutputTokens: "Output Tokens",
  agentRunsColumnIterations: "Iterations",
  agentAttachedResources: "Attached resources",
  agentAttachmentResource: "Resource",
  agentAttachmentTimeAttached: "Time attached",
  agentAttachmentAttachedBy: "Attached by",
  agentDetach: "Detach",
  agentAddAgent: "Add agent",
  agentAddAgentDescription: "Create a new Cursor Cloud agent template.",
  agents: "Agents",
  agentNewAgent: "New agent",
  agentUpdateAgent: "Update agent",
  agentDeleteAgent: "Delete agent",
  ...
  agentLaunchedSuccessfully: "Agent launched successfully.",
  agentLaunchFailed: "Failed to launch agent.",
  agentPromptSetSuccessfully: "Agent prompt set successfully.",
  agentPromptSetFailed: "Failed to set agent prompt.",
  agentResetConversationHistory: "Reset conversation history",
  agentSelectThisInstruction: "Select this instruction",
  agentDebug: "[DEBUG]",
  ...
  agentWorkOnThisCard: "Work on this card",
  ...
  ["onboarding.video.text1"]: "Congratulations 👏",
  ["onboarding.video.text2"]: "You just created your first board in",
  ["onboarding.video.text3"]: "Catch your breath for a moment...",
  forExample: "For example",
  createYourProfile: "Create your profile",
  createYourProfileDescription: "This is how you'll appear in Superthread",
  createYourProfileInputDesc: "You can change this later",
  ...
  noFormsForThisBoard: "No forms for this board",
  formsSettingsDescription: "Create and manage forms for this board",
  formNameAndIcon: "Form name and icon",
  formNameCannotBeEmpty: "Form name cannot be empty",
  thisIsHowPeopleWillSeeForm: "This is how people will see your form",
  formDescription: "Form description",
  descriptionWillBeShownOnPublicForm:
    "Description will be shown on the public form",
  enterFormDescription: "Enter form description",
  formFields: "Form fields",
  addFieldsForUsersToFillOut: "Add fields for users to fill out",
  fieldType: "Field type",
  selectTypeOfField: "Select type of field",
  ...
  optionalPlaceholderText: "Optional placeholder text",
  enterPlaceholder: "Enter placeholder",
  required: "Required",
  makeThisFieldRequired: "Make this field required",
  option: "Option",
  addOption: "Add option",
  addOptionsForThisField: "Add options for this field",
  atLeastTwoOptionsRequired: "At least two options required",
  ...
  phone: "Phone",
  link: "Link",
  maximumCharactersAllowed: "Maximum characters allowed",
